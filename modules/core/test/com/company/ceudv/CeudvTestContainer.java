...
public class CeudvTestContainer extends TestContainer {

    public CeudvTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ceudv/app.properties",
    ...
    public static class Common extends CeudvTestContainer {

        public static final CeudvTestContainer.Common INSTANCE = new CeudvTestContainer.Common();
